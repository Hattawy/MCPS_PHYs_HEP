...
#define WaveDump_Release        "3.7.4_20161222"
#define WaveDump_Release_Date   "Sept 2016"
#define DBG_TIME
...
int main(int argc, char *argv[])
{
    ...
    int cntwrevnt = 0; //enm count number of envents written to disk

    printf("\n");
    printf("enm:	Ed May revision 2\n");
    printf("**************************************************************\n");
    printf("                        Wave Dump %s\n", WaveDump_Release);
    printf("**************************************************************\n");
...
InterruptTimeout:
        ...
        for(i = 0; i < (int)NumEvents; i++) {
		   ...
		   cntwrevnt = cntwrevnt+1;
		    if ( cntwrevnt%10 == 0 ) printf("enm: count of events written to disk is %d\n", cntwrevnt);
